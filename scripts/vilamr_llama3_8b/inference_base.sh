...
cot_prompt_types='mr_rat mr_detail mr_rat mr_detail mr_detail mr_detail mr_detail mr_rat'

GPULIST=(0 1 2 3 4 5 6 7)
CHUNKS=${#GPULIST[@]}
for IDX in $(seq 0 $((CHUNKS-1))); do
  CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python vilamr/eval/inference_llama3.py \
