...
# *****************************************************************************
output=experiments/sft-266k_v1-ep${epoch}_bs${tbs}_lr${lr}/vilamr-vicuna-13b
mkdir -p $output
...
deepspeed vilamr/train/train_mem.py \
    ...
    --pretrain_mm_mlp_adapter playground/checkpoints/vilamr-vicuna-13b-pretrain/mm_projector.bin \
