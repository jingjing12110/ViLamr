...
def apply_chat_template(
    ...
    special_tokens_map = {'bos_token': '<|begin_of_text|>',
...
conv_llava_llama_3 = Conversation(
    ...
    offset=0,
    sep_style=SeparatorStyle.LLAMA_3,
    tokenizer=AutoTokenizer.from_pretrained("playground/checkpoints/Meta-Llama-3-8B-Instruct"),
    stop_token_ids=[128009],
)
...
conv_llava_llama_3_1 = Conversation(
    ...
    tokenizer=AutoTokenizer.from_pretrained("playground/checkpoints/Meta-Llama-3.1-8B-Instruct"),
...
if __name__ == "__main__":
    ...
    print(conv_llava_llama_3.get_prompt())
